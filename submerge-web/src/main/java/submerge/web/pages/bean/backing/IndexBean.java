package submerge.web.pages.bean.backing;
...
import submerge.web.constant.SupportedLocales;
import submerge.web.model.entity.SubtitleProfile;
import submerge.web.pages.bean.AbstractManagedBean;
import submerge.web.pages.bean.model.UserBean;
import submerge.web.pages.bean.model.UserSubConfigBean;
import submerge.web.service.UserService;
import submerge.web.utils.ProfileUtils;
import submerge.web.utils.UploadedFileUtils;
...
public class IndexBean extends AbstractManagedBean implements Serializable {
	...
	public void doInit() {
		...
		ProfileUtils.initProfiles(top, bottom);
	...
	public StreamedContent getGeneratedFile() {
		...
		if (topSub != null && bottomSub != null) {
			SubInput top = ProfileUtils.createSubInput(topSub, this.userConfig.getProfileTop(), "Top", 8);
			SubInput bottom = ProfileUtils.createSubInput(bottomSub, this.userConfig.getProfileBottom(), "Bottom", 2);
			ASSSub sub = new SubtitleConverter().mergeToAss(top, bottom);
